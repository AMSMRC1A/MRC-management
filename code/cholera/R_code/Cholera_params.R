...
params <- c(mu1 = 0, mu2 = 0,                      # natural birth/death rate 1E-4
            beta_I1 = 2.14E-5, beta_I2 = 2.14E-5,              # transmission rate from people (consider settings to 0)
            ...
            rho1 = 0.05, rho2 = 0.05)#,            # pathogen movement rate in water (consider decreasing by half)
