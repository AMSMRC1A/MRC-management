...
% patch 1
N1 = 1e6; 
S1 = N1-1000; %0.8*N1; %N1-150; 
E1 = 700; %0.1*N1; %700; %125; 
I1 = 300; %0.1*N1; %300; %25; 
H1 = 0;
D1 = 0;
R1 = 0;
ci = 0;
...
C1 = 0.5; %0.95; %2; %0.95;
C2 = 0.5; %0.95; %2; %0.95;
epsilon1 = 1000; %500; %0.5;
epsilon2 = 1000; %500; %0.5;
...
betaD1 = 3.3/N1; %5.5e-7; 
%betaD1 = p*betaI1;
R0 = N1 * alpha1/(alpha1 + mu1) * 1/(gammaI1 + phi1 + deltaI1 + mu1) * (betaI1 + betaD1*deltaI1/xi1)
